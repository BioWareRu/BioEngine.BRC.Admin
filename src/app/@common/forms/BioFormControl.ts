...
export class BioFormControl extends FormControl {
  ...
  constructor(private _form: BaseFormComponent, private _name: string, private _model: any, private _property: string, validatorOrOpts?: ValidatorFn | ValidatorFn[] | AbstractControlOptions | null, asyncValidator?: AsyncValidatorFn | AsyncValidatorFn[] | null) {
