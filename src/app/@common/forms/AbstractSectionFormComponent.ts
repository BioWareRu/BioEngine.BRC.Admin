...
export abstract class AbstractSectionFormComponent<TModel extends ISiteEntity, TSaveModel extends SaveModelResponse<TModel>> extends AbstractSiteEntityFormComponent<TModel, TSaveModel> {
