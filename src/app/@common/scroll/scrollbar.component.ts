...
export class BrcPerfectScrollbarDirective implements AfterViewInit, OnDestroy {
    ...
    get brcPerfectScrollbarOptions(): any {
        // Return the options
     ...
     */
    @Input()
    set brcPerfectScrollbarOptions(value) {
        // Merge the options
    ...
    ngAfterViewInit(): void {
        ...
        if (this.brcPerfectScrollbarOptions.updateOnRouteChange) {
            this._router.events
                .pipe(
    ...
    _init(): void {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.brcPerfectScrollbarOptions
        });
    }
